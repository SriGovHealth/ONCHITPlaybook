  ...
  grunt.initConfig({
    ...
    uglify: {
      dist: {
        ...
        src: ['js/lib/jumplink.js','js/lib/outlink.js', 'js/vendor/jquery.js', 'js/lib/nav.js', 'js/vendor/sticky-kit.js', 'js/vendor/jquery.colorbox.js', 'js/lib/onc.js', 'js/lib/infographics.js'],
        dest: 'js/base.js'
      }
    },
